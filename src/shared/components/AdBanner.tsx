  ...
  return (
    <>
      <div className="w-full bg-dark-surface border-b border-dark-border relative overflow-hidden">
        ...
        {/* Contenido del Anuncio (Ahora abre modal en lugar de ir directo) */}
        <button 
          onClick={() => setSelectedAd(ad)}
          className="w-full flex flex-col md:flex-row items-center justify-between max-w-7xl mx-auto px-4 py-3 gap-4 hover:bg-dark-elevated transition-colors group text-left"
        >
